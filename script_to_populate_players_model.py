...
#Player Model (full_name,player_id,point_per_game,assists_per_game,rebounds_per_game,blocks_per_game,steals_per_game,turnovers_per_game,
#personal_fouls_per_game,free_throw_percentage,field_goal_percentage,minutes_per_game,three_point_percentage,games_played,team_id)
