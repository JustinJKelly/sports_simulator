...
def make_playoff_games(eastern_teams, western_teams):
    ...
    east_semi_3_6 = None
    east_semi_2_7 = None
    '''west_semi_1_8_series = None
    west_semi_4_5_series = None
    west_semi_3_6_series = None
    west_semi_2_7_series = None
    east_semi_1_8_series = None
    east_semi_4_5_series = None
    east_semi_3_6_series = None
    east_semi_2_7_series = None'''
    west_semi_1_8_series = []
    west_semi_4_5_series = []
    west_semi_3_6_series = []
    west_semi_2_7_series = []
    east_semi_1_8_series = []
    east_semi_4_5_series = []
    east_semi_3_6_series = []
    east_semi_2_7_series = []
    
    
    for i in range(0,4):
        higher_seed=western_teams[i]
        lower_seed=western_teams[lower]
        higher_id=Team.objects.get(team_name=western_teams[i]).team_id
        lower_id=Team.objects.get(team_name=western_teams[lower]).team_id
        num_wins_higher = 0 
        num_wins_lower = 0
        games = 1
        game_scores= [] #[higher_seed_score,lower_seed_score], [...]
        while num_wins_higher < 4 and num_wins_lower < 4:
            ...
            if return_val[higher_id] > return_val[lower_id]:
                num_wins_higher += 1
            else:
                num_wins_lower += 1 
                
            #print('team_name:', western_teams[i], '  wins high:',num_wins_higher, '  points:', return_val[higher_id] )
            #print('team_name:', western_teams[lower],'  wins low:',num_wins_lower, '  points:', return_val[lower_id] )
            game_scores.append([return_val[higher_id],return_val[lower_id]])
            
            games += 1
        
        if lower == 7:
            if num_wins_higher==4:
                west_semi_1_8 = higher_id
                west_semi_1_8_series.append('%s defeats %s (%d-%d)' % (western_teams[i],western_teams[lower],num_wins_higher,num_wins_lower))
                west_semi_1_8_series.append(Team.objects.get(team_name=western_teams[i]).team_id)
                west_semi_1_8_series.append(Team.objects.get(team_name=western_teams[lower]).team_id)
                west_semi_1_8_series.append(num_wins_higher)
                west_semi_1_8_series.append(num_wins_lower)
                west_semi_1_8_series.append(game_scores)
            else:
                west_semi_1_8 = lower_id
                west_semi_1_8_series.append('%s defeats %s (%d-%d)' % (western_teams[lower],western_teams[i],num_wins_lower,num_wins_higher))
                west_semi_1_8_series.append(Team.objects.get(team_name=western_teams[i]).team_id)
                west_semi_1_8_series.append(Team.objects.get(team_name=western_teams[lower]).team_id)
                west_semi_1_8_series.append(num_wins_higher)
                west_semi_1_8_series.append(num_wins_lower)
            ...
            if num_wins_higher==4:
                west_semi_2_7 = higher_id
                west_semi_2_7_series.append('%s defeats %s (%d-%d)' % (western_teams[i],western_teams[lower],num_wins_higher,num_wins_lower))
                west_semi_2_7_series.append(Team.objects.get(team_name=western_teams[i]).team_id)
                west_semi_2_7_series.append(Team.objects.get(team_name=western_teams[lower]).team_id)
                west_semi_2_7_series.append(num_wins_higher)
                west_semi_2_7_series.append(num_wins_lower)
                west_semi_2_7_series.append(game_scores)
            else:
                west_semi_2_7 = lower_id
                west_semi_2_7_series.append('%s defeats %s (%d-%d)' % (western_teams[lower],western_teams[i],num_wins_lower,num_wins_higher))
                west_semi_2_7_series.append(Team.objects.get(team_name=western_teams[i]).team_id)
                west_semi_2_7_series.append(Team.objects.get(team_name=western_teams[lower]).team_id)
                west_semi_2_7_series.append(num_wins_higher)
                west_semi_2_7_series.append(num_wins_lower)
            ...
            if num_wins_higher==4:
                west_semi_3_6 = higher_id
                west_semi_3_6_series.append('%s defeats %s (%d-%d)' % (western_teams[i],western_teams[lower],num_wins_higher,num_wins_lower))
                west_semi_3_6_series.append(Team.objects.get(team_name=western_teams[i]).team_id)
                west_semi_3_6_series.append(Team.objects.get(team_name=western_teams[lower]).team_id)
                west_semi_3_6_series.append(num_wins_higher)
                west_semi_3_6_series.append(num_wins_lower)
                west_semi_3_6_series.append(game_scores)
            else:
                west_semi_3_6 = lower_id
                west_semi_3_6_series.append('%s defeats %s (%d-%d)' % (western_teams[lower],western_teams[i],num_wins_lower,num_wins_higher))
                west_semi_3_6_series.append(Team.objects.get(team_name=western_teams[i]).team_id)
                west_semi_3_6_series.append(Team.objects.get(team_name=western_teams[lower]).team_id)
                west_semi_3_6_series.append(num_wins_higher)
                west_semi_3_6_series.append(num_wins_lower)
            ...
            if num_wins_higher==4:
                west_semi_4_5 = higher_id
                west_semi_4_5_series.append('%s defeats %s (%d-%d)' % (western_teams[i],western_teams[lower],num_wins_higher,num_wins_lower))
                west_semi_4_5_series.append(Team.objects.get(team_name=western_teams[i]).team_id)
                west_semi_4_5_series.append(Team.objects.get(team_name=western_teams[lower]).team_id)
                west_semi_4_5_series.append(num_wins_higher)
                west_semi_4_5_series.append(num_wins_lower)
                west_semi_4_5_series.append(game_scores)
            else:
                west_semi_4_5 = lower_id
                west_semi_4_5_series.append('%s defeats %s (%d-%d)' % (western_teams[lower],western_teams[i],num_wins_lower,num_wins_higher))
                west_semi_4_5_series.append(Team.objects.get(team_name=western_teams[i]).team_id)
                west_semi_4_5_series.append(Team.objects.get(team_name=western_teams[lower]).team_id)
                west_semi_4_5_series.append(num_wins_higher)
                west_semi_4_5_series.append(num_wins_lower)
    ...
    #Eastern
    for i in range(0,4):
        higher_seed=eastern_teams[i]
        lower_seed=eastern_teams[lower]
        higher_id=Team.objects.get(team_name=eastern_teams[i]).team_id
        lower_id=Team.objects.get(team_name=eastern_teams[lower]).team_id
        num_wins_higher = 0 
        num_wins_lower = 0
        games = 1
        game_scores = []
        while num_wins_higher < 4 and num_wins_lower < 4:
            ...
            #print('team_name:', eastern_teams[i], '  wins high:',num_wins_higher, '  points:', return_val[higher_id] )
            #print('team_name:', eastern_teams[lower],'  wins low:',num_wins_lower, '  points:', return_val[lower_id] )
            game_scores.append([return_val[higher_id],return_val[lower_id]])
        
        if lower == 7:
            if num_wins_higher==4:
                east_semi_1_8 = higher_id
                east_semi_1_8_series.append('%s defeats %s (%d-%d)' % (eastern_teams[i],eastern_teams[lower],num_wins_higher,num_wins_lower))
                east_semi_1_8_series.append(Team.objects.get(team_name=eastern_teams[i]).team_id)
                east_semi_1_8_series.append(Team.objects.get(team_name=eastern_teams[lower]).team_id)
                east_semi_1_8_series.append(num_wins_higher)
                east_semi_1_8_series.append(num_wins_lower)
                east_semi_1_8_series.append(game_scores)
            else:
                east_semi_1_8 = lower_id
                east_semi_1_8_series.append('%s defeats %s (%d-%d)' % (eastern_teams[lower],eastern_teams[i],num_wins_lower,num_wins_higher))
                east_semi_1_8_series.append(Team.objects.get(team_name=eastern_teams[i]).team_id)
                east_semi_1_8_series.append(Team.objects.get(team_name=eastern_teams[lower]).tesam_id)
                east_semi_1_8_series.append(num_wins_higher)
                east_semi_1_8_series.append(num_wins_lower)
                east_semi_1_8_series.append(game_scores)
        elif lower == 6:
            if num_wins_higher==4:
                east_semi_2_7 = higher_id
                east_semi_2_7_series.append('%s defeats %s (%d-%d)' % (eastern_teams[i],eastern_teams[lower],num_wins_higher,num_wins_lower))
                east_semi_2_7_series.append(Team.objects.get(team_name=eastern_teams[i]).team_id)
                east_semi_2_7_series.append(Team.objects.get(team_name=eastern_teams[lower]).team_id)
                east_semi_2_7_series.append(num_wins_higher)
                east_semi_2_7_series.append(num_wins_lower)
                east_semi_2_7_series.append(game_scores)
            else:
                east_semi_2_7 = lower_id
                east_semi_2_7_series.append('%s defeats %s (%d-%d)' % (eastern_teams[lower],eastern_teams[i],num_wins_lower,num_wins_higher))
                east_semi_2_7_series.append(Team.objects.get(team_name=eastern_teams[i]).team_id)
                east_semi_2_7_series.append(Team.objects.get(team_name=eastern_teams[lower]).team_id)
                east_semi_2_7_series.append(num_wins_higher)
                east_semi_2_7_series.append(num_wins_lower)
            ...
            if num_wins_higher==4:
                east_semi_3_6 = higher_id
                east_semi_3_6_series.append('%s defeats %s (%d-%d)' % (eastern_teams[i],eastern_teams[lower],num_wins_higher,num_wins_lower))
                east_semi_3_6_series.append(Team.objects.get(team_name=eastern_teams[i]).team_id)
                east_semi_3_6_series.append(Team.objects.get(team_name=eastern_teams[lower]).team_id)
                east_semi_3_6_series.append(num_wins_higher)
                east_semi_3_6_series.append(num_wins_lower)
                east_semi_3_6_series.append(game_scores)
            else:
                east_semi_3_6 = lower_id
                east_semi_3_6_series.append('%s defeats %s (%d-%d)' % (eastern_teams[lower],eastern_teams[i],num_wins_lower,num_wins_higher))
                east_semi_3_6_series.append(Team.objects.get(team_name=eastern_teams[i]).team_id)
                east_semi_3_6_series.append(Team.objects.get(team_name=eastern_teams[lower]).team_id)
                east_semi_3_6_series.append(num_wins_higher)
                east_semi_3_6_series.append(num_wins_lower)
            ...
            if num_wins_higher==4:
                east_semi_4_5 = higher_id
                east_semi_4_5_series.append('%s defeats %s (%d-%d)' % (eastern_teams[i],eastern_teams[lower],num_wins_higher,num_wins_lower))
                east_semi_4_5_series.append(Team.objects.get(team_name=eastern_teams[i]).team_id)
                east_semi_4_5_series.append(Team.objects.get(team_name=eastern_teams[lower]).team_id)
                east_semi_4_5_series.append(num_wins_higher)
                east_semi_4_5_series.append(num_wins_lower)
                east_semi_4_5_series.append(game_scores)
            else:
                east_semi_4_5 = lower_id
                east_semi_4_5_series.append('%s defeats %s (%d-%d)' % (eastern_teams[lower],eastern_teams[i],num_wins_lower,num_wins_higher))
                east_semi_4_5_series.append(Team.objects.get(team_name=eastern_teams[i]).team_id)
                east_semi_4_5_series.append(Team.objects.get(team_name=eastern_teams[lower]).team_id)
                east_semi_4_5_series.append(num_wins_higher)
                east_semi_4_5_series.append(num_wins_lower)
    ...
    '''print('west_semi_1_8',west_semi_1_8, '  name:',Team.objects.get(team_id=west_semi_1_8).team_name)
    print('west_semi_2_7',west_semi_2_7, '  name:',Team.objects.get(team_id=west_semi_2_7).team_name)
    print('west_semi_3_6',west_semi_3_6, '  name:',Team.objects.get(team_id=west_semi_3_6).team_name)
    print('west_semi_4_5',west_semi_4_5, '  name:',Team.objects.get(team_id=west_semi_4_5).team_name)
    print('east_semi_1_8',east_semi_1_8, '  name:',Team.objects.get(team_id=east_semi_1_8).team_name)
    print('east_semi_2_7',east_semi_2_7, '  name:',Team.objects.get(team_id=east_semi_2_7).team_name)
    print('east_semi_3_6',east_semi_3_6, '  name:',Team.objects.get(team_id=east_semi_3_6).team_name)
    print('east_semi_4_5',east_semi_4_5, '  name:',Team.objects.get(team_id=east_semi_4_5).team_name)'''
    
    print(west_semi_1_8_series)
    print(west_semi_2_7_series)
    print(west_semi_3_6_series)
    print(west_semi_4_5_series)
    print(east_semi_1_8_series)
    print(east_semi_2_7_series)
    print(east_semi_3_6_series)
    print(east_semi_4_5_series)
    ...
    #semifinals
    if western_teams.index(Team.objects.get(team_id=west_semi_1_8).team_name) < western_teams.index(Team.objects.get(team_id=west_semi_4_5).team_name):
        west_conf_1_all = run_one_series(west_semi_1_8,west_semi_4_5)
        west_conf_1 = west_conf_1_all[0]
        if west_conf_1 == west_semi_1_8:
            print('%s defeats %s (%d-%d)' % (Team.objects.get(team_id=west_semi_1_8).team_name,Team.objects.get(team_id=west_semi_4_5).team_name,west_conf_1_all[1],west_conf_1_all[2]))
        else:
            print('%s defeats %s (%d-%d)' % (Team.objects.get(team_id=west_semi_4_5).team_name,Team.objects.get(team_id=west_semi_1_8).team_name,west_conf_1_all[2],west_conf_1_all[1]))
        west_conf_1_series.append("False")
        west_conf_1_series.append(west_semi_1_8)
        west_conf_1_series.append(west_semi_4_5)
        west_conf_1_series.append(west_conf_1_all[1])
        west_conf_1_series.append(west_conf_1_all[2])
        west_conf_1_series.append(west_conf_1_all[3])
    else:
        west_conf_1_all = run_one_series(west_semi_4_5,west_semi_1_8)
        west_conf_1 = west_conf_1_all[0]
        if west_conf_1 == west_semi_4_5:
            print('%s defeats %s (%d-%d)' % (Team.objects.get(team_id=west_semi_4_5).team_name,Team.objects.get(team_id=west_semi_1_8).team_name,west_conf_1_all[1],west_conf_1_all[2]))
        else:
            print('%s defeats %s (%d-%d)' % (Team.objects.get(team_id=west_semi_1_8).team_name,Team.objects.get(team_id=west_semi_4_5).team_name,west_conf_1_all[2],west_conf_1_all[1]))
        west_conf_1_series.append("True")
        west_conf_1_series.append(west_semi_4_5)
        west_conf_1_series.append(west_semi_1_8)
        west_conf_1_series.append(west_conf_1_all[1])
        west_conf_1_series.append(west_conf_1_all[2])
    ...
    if western_teams.index(Team.objects.get(team_id=west_semi_2_7).team_name) < western_teams.index(Team.objects.get(team_id=west_semi_3_6).team_name):
        west_conf_2_all = run_one_series(west_semi_2_7,west_semi_3_6)
        west_conf_2 = west_conf_2_all[0]
        if west_conf_2 == west_semi_2_7:
            print('%s defeats %s (%d-%d)' % (Team.objects.get(team_id=west_semi_2_7).team_name,Team.objects.get(team_id=west_semi_3_6).team_name,west_conf_1_all[1],west_conf_2_all[2]))
        else:
            print('%s defeats %s (%d-%d)' % (Team.objects.get(team_id=west_semi_3_6).team_name,Team.objects.get(team_id=west_semi_2_7).team_name,west_conf_2_all[2],west_conf_2_all[1]))
        west_conf_2_series.append("False")
        west_conf_2_series.append(west_semi_2_7)
        west_conf_2_series.append(west_semi_3_6)
        west_conf_2_series.append(west_conf_2_all[1])
        west_conf_2_series.append(west_conf_2_all[2])
        west_conf_2_series.append(west_conf_2_all[3])
    else:
        west_conf_2_all = run_one_series(west_semi_3_6,west_semi_2_7)
        west_conf_2 = west_conf_2_all[0]
    
        if west_conf_2 == west_semi_3_6:
            print('%s defeats %s (%d-%d)' % (Team.objects.get(team_id=west_semi_3_6).team_name,Team.objects.get(team_id=west_semi_2_7).team_name,west_conf_1_all[1],west_conf_2_all[2]))
        else:
            print('%s defeats %s (%d-%d)' % (Team.objects.get(team_id=west_semi_2_7).team_name,Team.objects.get(team_id=west_semi_3_6).team_name,west_conf_2_all[2],west_conf_2_all[1]))
        west_conf_2_series.append("True")
        west_conf_2_series.append(west_semi_3_6)
        west_conf_2_series.append(west_semi_2_7)
        west_conf_2_series.append(west_conf_2_all[1])
        west_conf_2_series.append(west_conf_2_all[2])
    ...
    if eastern_teams.index(Team.objects.get(team_id=east_semi_1_8).team_name) < eastern_teams.index(Team.objects.get(team_id=east_semi_4_5).team_name):
        east_conf_1_all = run_one_series(east_semi_1_8,east_semi_4_5)
        east_conf_1 = east_conf_1_all[0]
        if east_conf_1 == east_semi_1_8:
            print('%s defeats %s (%d-%d)' % (Team.objects.get(team_id=east_semi_1_8).team_name,Team.objects.get(team_id=east_semi_4_5).team_name,east_conf_1_all[1],east_conf_1_all[2]))
        else:
            print('%s defeats %s (%d-%d)' % (Team.objects.get(team_id=east_semi_4_5).team_name,Team.objects.get(team_id=east_semi_1_8).team_name,east_conf_1_all[2],east_conf_1_all[1]))
        east_conf_1_series.append("False")
        
        east_conf_1_series.append(east_semi_1_8)
        east_conf_1_series.append(east_semi_4_5)
        east_conf_1_series.append(east_conf_1_all[1])
        east_conf_1_series.append(east_conf_1_all[2])
        east_conf_1_series.append(east_conf_1_all[3])
    else:
        east_conf_1_all = run_one_series(east_semi_4_5,east_semi_1_8)
        east_conf_1 = east_conf_1_all[0]
    
        if east_conf_1 == east_semi_4_5:
            print('%s defeats %s (%d-%d)' % (Team.objects.get(team_id=east_semi_4_5).team_name,Team.objects.get(team_id=east_semi_1_8).team_name,east_conf_1_all[1],east_conf_1_all[2]))
        else:
            print('%s defeats %s (%d-%d)' % (Team.objects.get(team_id=east_semi_1_8).team_name,Team.objects.get(team_id=east_semi_4_5).team_name,east_conf_1_all[2],east_conf_1_all[1]))
        east_conf_1_series.append("True")
    ...
    if eastern_teams.index(Team.objects.get(team_id=east_semi_2_7).team_name) < eastern_teams.index(Team.objects.get(team_id=east_semi_3_6).team_name):
        east_conf_2_all = run_one_series(east_semi_2_7,east_semi_3_6)
        east_conf_2 = east_conf_2_all[0]
        if east_conf_2 == east_semi_2_7:
            print('%s defeats %s (%d-%d)' % (Team.objects.get(team_id=east_semi_2_7).team_name,Team.objects.get(team_id=east_semi_3_6).team_name,east_conf_2_all[1],east_conf_2_all[2]))
        else:
            print('%s defeats %s (%d-%d)' % (Team.objects.get(team_id=east_semi_3_6).team_name,Team.objects.get(team_id=east_semi_2_7).team_name,east_conf_2_all[2],east_conf_2_all[1]))
        east_conf_2_series.append("False")
        east_conf_2_series.append(east_semi_2_7)
        east_conf_2_series.append(east_semi_3_6)
        east_conf_2_series.append(east_conf_2_all[1])
        east_conf_2_series.append(east_conf_2_all[2])
        east_conf_2_series.append(east_conf_2_all[3])
        
    else:
        east_conf_2_all = run_one_series(east_semi_3_6,east_semi_2_7)
        east_conf_2 = east_conf_2_all[0]
    
        if east_conf_2 == east_semi_3_6:
            print('%s defeats %s (%d-%d)' % (Team.objects.get(team_id=east_semi_3_6).team_name,Team.objects.get(team_id=east_semi_2_7).team_name,east_conf_2_all[1],east_conf_2_all[2]))
        else:
            print('%s defeats %s (%d-%d)' % (Team.objects.get(team_id=east_semi_2_7).team_name,Team.objects.get(team_id=east_semi_3_6).team_name,east_conf_2_all[2],east_conf_2_all[1]))
        east_conf_2_series.append("True")
        east_conf_2_series.append(east_semi_3_6)
        east_conf_2_series.append(east_semi_2_7)
        east_conf_2_series.append(east_conf_2_all[1])
        east_conf_2_series.append(east_conf_2_all[2])
    ...
    print(west_conf_1_series)
    print(west_conf_2_series)
    print(east_conf_1_series)
    print(east_conf_2_series)
    '''print('east_conf_1_8_4_5',east_conf_1, '  name:',Team.objects.get(team_id=east_conf_1).team_name)
    print('east_conf_2_7_3_6',east_conf_2, '  name:',Team.objects.get(team_id=east_conf_2).team_name)
    print('west_conf_1_8_4_5',west_conf_1, '  name:',Team.objects.get(team_id=west_conf_1).team_name)
    print('west_conf_2_7_3_6',west_conf_2, '  name:',Team.objects.get(team_id=west_conf_2).team_name)'''
        
    east_finals_series = [] 
    west_finals_series = []
    
    if eastern_teams.index(Team.objects.get(team_id=east_conf_1).team_name) < eastern_teams.index(Team.objects.get(team_id=east_conf_2).team_name):
        east_final = run_one_series(east_conf_1,east_conf_2)
        if east_final[0] == east_conf_1:
            print('%s defeats %s (%d-%d)' % (Team.objects.get(team_id=east_final[0]).team_name,Team.objects.get(team_id=east_final[4]).team_name,east_final[1],east_final[2]))
        else:
            print('%s defeats %s (%d-%d)' % (Team.objects.get(team_id=east_final[0]).team_name,Team.objects.get(team_id=east_final[4]).team_name,east_final[2],east_final[1]))
        east_finals_series.append("False")
        east_finals_series.append(east_conf_1)
        east_finals_series.append(east_conf_2)
        east_finals_series.append(east_final[1])
        east_finals_series.append(east_final[2])
        east_finals_series.append(east_final[3])
    else:
        east_final = run_one_series(east_conf_2,east_conf_1) 
        if east_final[0] == east_conf_2:
            print('%s defeats %s (%d-%d)' % (Team.objects.get(team_id=east_final[0]).team_name,Team.objects.get(team_id=east_final[4]).team_name,east_final[1],east_final[2]))
        else:
            print('%s defeats %s (%d-%d)' % (Team.objects.get(team_id=east_final[0]).team_name,Team.objects.get(team_id=east_final[4]).team_name,east_final[2],east_final[1]))
        east_finals_series.append("True")
        east_finals_series.append(east_conf_2)
        east_finals_series.append(east_conf_1)
        east_finals_series.append(east_final[1])
        east_finals_series.append(east_final[2])
    ...
    if western_teams.index(Team.objects.get(team_id=west_conf_1).team_name) < western_teams.index(Team.objects.get(team_id=west_conf_2).team_name):
        west_final = run_one_series(west_conf_1,west_conf_2)
        if west_final[0] == west_conf_1:
            print('%s defeats %s (%d-%d)' % (Team.objects.get(team_id=west_final[0]).team_name,Team.objects.get(team_id=west_final[4]).team_name,west_final[1],west_final[2]))
        else:
            print('%s defeats %s (%d-%d)' % (Team.objects.get(team_id=west_final[0]).team_name,Team.objects.get(team_id=west_final[4]).team_name,west_final[2],west_final[1]))
        west_finals_series.append("False")
        west_finals_series.append(west_conf_1)
        west_finals_series.append(west_conf_2)
        west_finals_series.append(west_final[1])
        west_finals_series.append(west_final[2])
        west_finals_series.append(west_final[3])
    else:
        west_final = run_one_series(west_conf_2,west_conf_1) 
        if west_final[0] == west_conf_2:
            print('%s defeats %s (%d-%d)' % (Team.objects.get(team_id=west_final[0]).team_name,Team.objects.get(team_id=west_final[4]).team_name,west_final[1],west_final[2]))
        else:
            print('%s defeats %s (%d-%d)' % (Team.objects.get(team_id=west_final[0]).team_name,Team.objects.get(team_id=west_final[4]).team_name,west_final[2],west_final[1]))
        west_finals_series.append("True")
        west_finals_series.append(west_conf_2)
        west_finals_series.append(west_conf_1)
        west_finals_series.append(west_final[1])
        west_finals_series.append(west_final[2])
    ...
    #print('east_conf_final',east_final[0], '  name:',Team.objects.get(team_id=east_final[0]).team_name)
    #print('west_conf_final',west_final[0], '  name:',Team.objects.get(team_id=west_final[0]).team_name)
    print("west:", west_finals_series)
    print("east:", east_finals_series)
    print("west:", Team.objects.get(team_id=west_final[0]).team_name)
    print("east:", Team.objects.get(team_id=east_final[0]).team_name)
    
    finals_series = []
    
    #west higher seed
    if western_teams.index(Team.objects.get(team_id=west_final[0]).team_name) > eastern_teams.index(Team.objects.get(team_id=east_final[0]).team_name):
        finals = run_one_series(east_final[0],west_final[0]) 
        #finals_series.append("True")
        if east_final[0] == finals[0]:
            finals_series.append("False")
            print('%s defeats %s (%d-%d)' % (Team.objects.get(team_id=finals[0]).team_name,Team.objects.get(team_id=finals[4]).team_name,finals[1],finals[2]))
            finals_series.append(Team.objects.get(team_id=finals[0]).team_name)
            finals_series.append(east_final[0])
            finals_series.append(west_final[0])
            finals_series.append(finals[1])
            finals_series.append(finals[2])
        else:
            finals_series.append("True")
            print('%s defeats %s (%d-%d)' % (Team.objects.get(team_id=finals[0]).team_name,Team.objects.get(team_id=finals[4]).team_name,finals[2],finals[1]))
            finals_series.append(Team.objects.get(team_id=finals[0]).team_name)
            finals_series.append(east_final[0])
            finals_series.append(west_final[0])
            finals_series.append(finals[2])
        ...
        finals = run_one_series(west_final[0],east_final[0]) 
        #finals_series.append("False")
        if west_final[0] == finals[0]:
            finals_series.append("False")
            print('%s defeats %s (%d-%d)' % (Team.objects.get(team_id=finals[0]).team_name,Team.objects.get(team_id=finals[4]).team_name,finals[1],finals[2]))
            finals_series.append(Team.objects.get(team_id=finals[0]).team_name)
            finals_series.append(west_final[0])
...
def run_one_series(higher_seed, lower_seed):
     #semifinals
    higher_id=higher_seed
    lower_id=lower_seed
    higher_name=Team.objects.get(team_id=higher_seed).team_name
    lower_name=Team.objects.get(team_id=lower_seed).team_name
    num_wins_higher = 0 
    num_wins_lower = 0
    games = 1
    game_scores = []
    while num_wins_higher < 4 and num_wins_lower < 4:
        if games == 1 or games == 2 or games == 5 or games == 7:
            return_val = playoff_sim(higher_id,lower_id)
        else:
            return_val = playoff_sim(lower_id,higher_id)
        ...
        #print('team_name:', higher_name, '  wins high:',num_wins_higher, '  points:', return_val[higher_id] )
        #print('team_name:', lower_name,'  wins low:',num_wins_lower, '  points:', return_val[lower_id] )
        game_scores.append([return_val[higher_id],return_val[lower_id]])

        games+=1
    
    if num_wins_higher == 4:
        return [higher_id, num_wins_higher, num_wins_lower,game_scores,lower_id]
    else:
        return [lower_id, num_wins_higher, num_wins_lower,game_scores,higher_id]
    ...
    for player in player_avg:
        if not player['injured']:
            ...
            if tid == 1610612746:
                ...
                three_pt_att_max -= 0.06
                three_pt_made_min -= 0.025
                three_pt_made_max -= 0.04
                free_throws_made_min += 0.02
                free_throws_made_max += 0.05
...
def get_bias_home_other(team_id):
    team_list_dist = {
        1610612749:[0.82, 1.015, -6, 3, 0.79, 1.015, -5, 55, 0.85, 1.015, -3, 6, -4, 5, -2, 3, -4, 5, -3, 3, -2, 3, -2, 3, -3, 3, -3, 3, -10, 10],#MIL
        1610612747:[0.84, 1.04, -6, 4.5, 0.79, 1.05, -5, 5, 0.86, 1.05, -3, 10, -4, 5, -2, 4, -3, 6, -4, 5, -3, 4, -2, 3, -3, 3, -3, 3, -7, 7], #LAL
        1610612737:[0.77, 1.045, -6, 4.5, 0.76, 1.05, -5.3, 5, 0.87, 1.05, -3, 10, -5,4, -3, 3, -6, 3, -3, 3, -3, 2, -2, 2, -3, 3, -3, 3, -4, 10],#ATL
        1610612738:[0.84, 1.045, -6, 4.5, 0.79, 1.05, -5.2, 5, 0.87, 1.05, -3, 10, -4, 4, -2, 2, -3, 3, -4, 6, -2, 3, -2, 3, -3, 2, -3, 3, -7, 10],#BOS
        1610612751:[0.78, 1.04, -6, 4.5, 0.74, 1.04, -5.2, 5, 0.85, 1.05, -3, 7, -4, 5, -3, 4, -3, 3, -3, 3, -2, 2, -2, 3, -4, 3, -3, 3, -7, 10],#BKN
        1610612766:[0.76, 1.04, -6, 4.5, 0.75, 1.05, -5, 5.3, 0.87, 1.05, -3.5, 10, -5, 4, -2, 2, -4, 3, -3, 2, -2, 2, -2, 2, -3, 2, -3, 3, -4, 10],#CHA
        1610612741:[0.77, 1.045, -6, 4.5, 0.76, 1.05, -5, 5.3, 0.87, 1.05, -3.5, 10, -3, 4, -4, 5, -3, 3, -3, 3, -2, 2, -2, 3, -4, 3, -3, 3, -7, 10],#CHI
        1610612739:[0.76, 1.04, -6, 4.5, 0.75, 1.05, -5, 5, 0.87, 1.05, -3.5, 10, -3, 4, -4, 5, -3, 3, -3, 3, -2, 2, -2, 3, -4, 3, -3, 3, -7, 10],#CLE
        1610612742:[0.83, 1.04, -6, 3.5, 0.77, 1.07, -5, 4, 0.88, 1.05, -3.5, 8, -3, 5, -4, 5, -3, 5, -3, 6, -2, 3, -2, 3, -4, 3, -3, 3, -7, 12],#DAL
        1610612743:[0.83, 1.045, -6, 4.5, 0.78, 1.07, -5, 5, 0.87, 1.05, -3.5, 10, -3, 4, -4, 4, -3, 4, -3, 4, -2, 3, -2, 3, -4, 3, -3, 3, -7, 12],#DEN
        1610612765:[0.77, 1.04, -6, 4.5, 0.76, 1.05, -5, 5, 0.85, 1.05, -3.5, 10, -3, 4, -4, 5, -3, 3, -3, 3, -2, 2, -2, 3, -4, 3, -3, 3, -7, 10],#DET
        1610612744:[0.78, 1.045, -6, 4.5, 0.77, 1.07, -5, 5, 0.89, 1.05, -3.5, 10, -3, 3, -3, 3, -3, 3, -3, 5, -2, 2, -2, 3, -4, 3, -3, 3, -7, 8],#GSW
        1610612745:[0.8, 1.04, -6, 5, 0.75, 1.06, -5, 4.5, 0.89, 1.045, -3.5, 7, -3, 4, -3, 4, -3, 4, -3, 5, -2, 4, -2, 2, -2, 4, -3, 3, -7, 12],#HOU
        1610612754:[0.81, 1.045, -6, 4.5, 0.78, 1.07, -5, 6, 0.87, 1.05, -3.5, 10, -3, 3, -3, 3, -3, 3, -3, 5, -2, 2, -2, 3, -4, 3, -3, 3, -7, 8],#IND
        1610612746:[0.84, 1.05, -6, 4, 0.79, 1.06, -5, 4.2, 0.87, 1.05, -3.5, 10, -3, 3, -3, 3, -3, 3, -3, 5, -2, 2, -2, 3, -4, 3, -3, 3, -7, 8],#LAC
        1610612763:[0.8, 1.045, -6, 4.5, 0.78, 1.05, -5, 5, 0.85, 1.05, -3.5, 10, -3, 4, -4, 5, -3, 3, -3, 3, -2, 2, -2, 3, -4, 3, -3, 3, -7, 10],#MEM
        1610612748:[0.85, 1.045, -6, 4.5, 0.79, 1.09, -5, 5, 0.9, 1.07, -3.5, 10, -3, 4, -4, 5, -3, 4, -3, 4, -2, 2, -2, 3, -4, 3, -3, 3, -7, 10],#MIA
        1610612750:[0.77, 1.045, -6, 4.5, 0.76, 1.05, -5, 5, 0.85, 1.05, -3.5, 10, -3, 4, -4, 5, -3, 4, -2, 4, -2, 2, -2, 3, -4, 3, -3, 3, -7, 10],#MIN
        1610612740:[0.77, 1.01, -6, 2, 0.75, 1.02, -5, 2, 0.85, 1.03, -3.5, 5, -3, 4, -4, 3, -3, 3, -2, 5, -2, 2, -2, 3, -4, 3, -3, 3, -7, 10],#NOR
        1610612752:[0.77, 1.04, -6, 4.5, 0.76, 1.05, -5, 5, 0.84, 1.05, -3.5, 10, -3, 4, -4, 3, -3, 3, -2, 5, -2, 2, -2, 3, -4, 3, -3, 3, -7, 10],#NYK
        1610612760:[0.84, 1.045, -6, 4.5, 0.77, 1.08, -5, 5, 0.87, 1.05, -3.5, 10, -3, 4, -4, 3, -3, 3, -2, 5, -2, 2, -2, 3, -4, 3, -3, 3, -7, 10],#OKC
        1610612753:[0.79, 1.045, -6, 4.5, 0.76, 1.05, -5, 5, 0.85, 1.05, -3.5, 10, -3, 4, -4, 3, -3, 3, -2, 5, -2, 2, -2, 3, -4, 3, -3, 3, -7, 10],#ORL
        1610612755:[0.85, 1.065, -6, 4.5, 0.78, 1.05, -5, 5, 0.87, 1.05, -3.5, 10, -3, 4, -4, 3, -3, 3, -2, 5, -2, 2, -2, 3, -4, 3, -3, 3, -7, 10],#PHI
        1610612756:[0.77, 1.045, -6, 4.5, 0.76, 1.06, -5, 5, 0.85, 1.05, -3.5, 10, -3, 4, -4, 3, -3, 3, -2, 5, -2, 2, -2, 3, -4, 3, -3, 3, -7, 10],#PHX
        1610612757:[0.78, 1.045, -6, 4.5, 0.77, 1.08, -5, 5, 0.85, 1.05, -3.5, 10, -3, 4, -4, 3, -3, 3, -2, 5, -2, 2, -2, 3, -4, 3, -3, 3, -7, 10],#POR
        1610612758:[0.77, 1.04, -6, 4.5, 0.76, 1.05, -5, 5, 0.85, 1.05, -3.5, 10, -4, 5, -4, 5, -3, 3, -3, 3, -2, 2, -2, 3, -4, 3, -3, 3, -7, 10],#SAC
        1610612759:[0.79, 1.045, -6, 4.5, 0.78, 1.05, -4, 4, 0.85, 1.05, -3.5, 10, -4, 5, -4, 5, -3, 3, -3, 5, -2 ,2, -2, 3, -4, 3, -3, 3, -7, 10],#SAS
        1610612761:[0.85, 1.065, -4, 4.5, 0.79, 1.06, -5, 5, 0.87, 1.05, -3.5, 10, -4, 5, -4, 5, -3, 3, -3, 5, -2, 2, -2, 3, -4, 3, -3, 3, -7, 10],#TOR
        1610612762:[0.83, 1.045, -6, 4.5, 0.78, 1.07, -5, 5, 0.85, 1.05, -3.5, 10, -3, 5, -4, 5, -3, 3, -3, 5, -2, 2, -2, 3, -4, 3, -3, 3, -7, 10],#UTA
        1610612764:[0.77, 1.045, -6, 4.5, 0.76, 1.05, -5, 5, 0.85, 1.05, -3.5, 10, -3, 4, -4, 5, -3, 3, -3, 5, -2, 2, -2, 3, -4, 3, -3, 3, -7, 10]#WIZ
    }
    return team_list_dist[team_id]

def get_bias_away_other(team_id):
    team_list_dist = {
        1610612749:[0.81, 1.015, -5.5, 2.5, 0.78, 1.015, -5, 4, 0.84, 1.025, -3, 5, -3, 5, -3, 4, -3, 4, -3, 3, -2, 2, -2, 3, -2, 1, -3, -3, -10, 10],#MIL
        1610612747:[0.825, 1.045, -5.5, 4, 0.79, 1.05, -5, 4, 0.83, 1.05, -3, 9, -4, 5, -2, 4, -3, 4, -4, 5, -3, 4, -2, 3, -1, 1, -3, 3, -7, 7], #LAL
        1610612737:[0.74, 1.04, -6.5, 4.4, 0.74, 1.04, -5.3, 5, 0.85, 1.05, -3, 9, -7,3, -2, 2, -4, 3, -3, 2, -2, 1, -1, 1, -3, 2, -3, 3, -4, 10],#ATL
        1610612738:[0.83, 1.04, -6.5, 4.5, 0.79, 1.05, -5.2, 4.6, 0.85, 1.05, -3, 9, -4, 4, -2, 2, -3, 3, -3, 5, -1, 3, -2, 3, -3, 2, -3, 3, -7, 10],#BOS
        1610612751:[0.74, 1.04, -6.5, 4.3, 0.74, 1.04, -5, 4, 0.85, 1.05, -3, 6, -3, 5, -4, 5, -3, 3, -3, 3, -2, 2, -2, 3, -4, 3, -3, 3, -7, 10],#BKN
        1610612766:[0.74, 1.04, -6.5, 4.2, 0.74, 1.04, -5, 4.3, 0.85, 1.05, -3, 9, -5, 3, -2, 2, -6, 3, -3, 2, -2, 1, -1, 1, -3, 2, -3, 3, -4, 10],#CHA
        1610612741:[0.77, 1.04, -6.5, 4.4, 0.77, 1.04, -5, 4.3, 0.85, 1.05, -3, 9, -3, 5, -4, 5, -3, 3, -3, 3, -2, 2, -2, 3, -4, 3, -3, 3, -7, 10],#CHI
        1610612739:[0.74, 1.04, -6.5, 4.2, 0.74, 1.04, -5, 5, 0.84, 1.05, -3, 9, -3, 5, -4, 5, -3, 3, -3, 3, -2, 2, -2, 3, -4, 3, -3, 3, -7, 10],#CLE
        1610612742:[0.82, 1.04, -6.5, 3.5, 0.77, 1.04, -5, 4, 0.86, 1.05, -3, 9, -3, 5, -4, 5, -3, 5, -3, 6, -2, 3, -2, 3, -4, 3, -3, 3, -7, 12],#DAL
        1610612743:[0.83, 1.04, -6.5, 5.3, 0.77, 1.05,-5, 5, 0.86, 1.05, -3, 9, -3, 4, -4, 4, -3, 4, -3, 4, -2, 3, -2, 3, -4, 3, -3, 3, -7, 12],#DEN
        1610612765:[0.74, 1.04, -6.5, 4.3, 0.74, 1.05, -5, 4, 0.82, 1.05, -3, 9, -3, 5, -4, 5, -3, 3, -3, 3, -2, 2, -2, 3, -4, 3, -3, 3, -7, 10],#DET
        1610612744:[0.75, 1.04, -6.5, 4, 0.75, 1.05, -5, 4.8, 0.87, 1.05, -3, 9, -3, 3, -3, 3, -3, 3, -3, 5, -2, 2, -2, 3, -4, 3, -3, 3, -7, 8],#GSW
        1610612745:[0.77, 1.04, -6.5, 4.5, 0.74, 1.05, -5, 4.5, 0.87, 1.04, -3, 6, -3, 4, -3, 4, -3, 4, -3, 5, -2, 4, -2, 2, -2, 4, -3, 3, -7, 12],#HOU
        1610612754:[0.82, 1.04, -6.5, 4.5, 0.77, 1.05, -5, 5.3, 0.85, 1.05, -3, 9, -3, 3, -3, 3, -3, 3, -3, 5, -2, 2, -2, 3, -4, 3, -3, 3, -7, 8],#IND
        1610612746:[0.84, 1.04, -6.5, 4, 0.78, 1.05, -5, 5, 0.84, 1.05, -3, 9, -3, 3, -3, 3, -3, 3, -3, 5, -2, 2, -2, 3, -4, 3, -3, 3, -7, 8],#LAC
        1610612763:[0.75, 1.04, -6.5, 4.5, 0.75, 1.05, -5, 4.4, 0.82, 1.05, -3, 9, -3, 4, -4, 5, -3, 3, -3, 3, -2, 2, -2, 3, -4, 3, -3, 3, -7, 10],#MEM
        1610612748:[0.83, 1.04, -6.5, 4.5, 0.78, 1.06, -5, 4.8, 0.87, 1.05, -3, 9, -3, 4, -4, 5, -3, 4, -3, 4, -2, 2, -2, 3, -4, 3, -3, 3, -7, 10],#MIA
        1610612750:[0.75, 1.04, -6.5, 4.3, 0.75, 1.04, -5, 4, 0.83, 1.05, -3, 9, -3, 4, -4, 5, -3, 4, -2, 4, -2, 2, -2, 3, -4, 3, -3, 3, -7, 10],#MIN
        1610612740:[0.75, 1.01, -6.5, 1, 0.75, 1.01, -5, 2, 0.83, 1.01, -3, 3, -3, 4, -4, 3, -3, 3, -2, 5, -2, 2, -2, 3, -4, 3, -3, 3, -7, 10],#NOR
        1610612752:[0.75, 1.04, -6.5, 4.1, 0.75, 1.03, -5, 4, 0.82, 1.05, -3, 9, -3, 4, -4, 3, -3, 3, -2, 5, -2, 2, -2, 3, -4, 3, -3, 3, -7, 10],#NYK
        1610612760:[0.84, 1.04, -6.5, 4.5, 0.76, 1.08, -5, 4.2, 0.85, 1.05, -3, 9, -3, 4, -4, 3, -3, 3, -2, 5, -2, 2, -2, 3, -4, 3, -3, 3, -7, 10],#OKC
        1610612753:[0.77, 1.04, -6.5, 4.2, 0.75, 1.04, -5, 4, 0.83, 1.05, -3, 9, -3, 4, -4, 3, -3, 3, -2, 5, -2, 2, -2, 3, -4, 3, -3, 3, -7, 10],#ORL
        1610612755:[0.82, 1.04, -6.5, 4.5, 0.76, 1.04, -5, 3.5, 0.85, 1.05, -3, 9, -3, 4, -4, 3, -3, 3, -2, 5, -2, 2, -2, 3, -4, 3, -3, 3, -7, 10],#PHI
        1610612756:[0.75, 1.04, -6.5, 4.4, 0.75, 1.04, -5, 4.4, 0.83, 1.05, -3, 9, -3, 4, -4, 3, -3, 3, -2, 5, -2, 2, -2, 3, -4, 3, -3, 3, -7, 10],#PHX
        1610612757:[0.76, 1.04, -6.5, 4.5, 0.76, 1.05, -5, 5, 0.83, 1.05, -3, 9, -3, 4, -4, 3, -3, 3, -2, 5, -2, 2, -2, 3, -4, 3, -3, 3, -7, 10],#POR
        1610612758:[0.75, 1.04, -6.5, 4.5, 0.75, 1.04, -5, 4, 0.83, 1.05, -5, 5, -3, 9, -4, 5, -3, 3, -3, 3, -2, 2, -2, 3, -4, 3, -3, 3, -7, 10],#SAC
        1610612759:[0.76, 1.04, -6.5, 4.4, 0.76, 1.05, -4, 4, 0.83, 1.05, -5, 5, -3, 9, -4, 5, -3, 3, -3, 5, -2 ,2, -2, 3, -4, 3, -3, 3, -7, 10],#SAS
        1610612761:[0.84, 1.045, -4.5, 4.5, 0.78, 1.06, -5, 5, 0.86, 1.05, -5, 5, -3, 9, -4, 5, -3, 3, -3, 5, -2, 2, -2, 3, -4, 3, -3, 3, -7, 10],#TOR
        1610612762:[0.83, 1.04, -6.5, 4.5, 0.77, 1.06, -5, 4.5, 0.86, 1.05, -5, 5, -3, 9, -4, 5, -3, 3, -3, 5, -2, 2, -2, 3, -4, 3, -3, 3, -7, 10],#UTA
...
def get_bias_home(team_id):
    team_list_dist = {
        ...
        1610612747:[0.92, 1.16, -4, 5, 0.88, 1.12, -5, 5.4, 0.87, 1.1, -3, 10, -4, 5, -2, 4, -3, 6, -4, 5, -3, 4, -2, 3, -3, 3, -3, 3, -7, 7], #LAL
        1610612737:[0.88, 1.13, -4, 4.4, 0.87, 1.12, -5.3, 6.5, 0.9, 1.1, -3, 10, -5,4, -3, 3, -6, 3, -3, 3, -3, 2, -2, 2, -3, 3, -3, 3, -4, 10],#ATL
        1610612738:[0.9, 1.14, -4, 5, 0.87, 1.1, -5.2, 5.5, 0.9, 1.1, -3, 10, -4, 4, -2, 2, -3, 3, -4, 6, -2, 3, -2, 3, -3, 2, -3, 3, -7, 10],#BOS
        1610612751:[0.87, 1.12, -4, 4.3, 0.87, 1.1, -5.2, 5, 0.9, 1.1, -3, 10, -4, 5, -3, 4, -3, 3, -3, 3, -2, 2, -2, 3, -4, 3, -3, 3, -7, 10],#BKN
        1610612766:[0.87, 1.11, -4, 4.2, 0.87, 1.1, -5, 5.3, 0.9, 1.1, -3.5, 10, -5, 4, -2, 2, -4, 3, -3, 2, -2, 2, -2, 2, -3, 2, -3, 3, -4, 10],#CHA
        1610612741:[0.88, 1.13, -4, 4.4, 0.88, 1.1, -5, 5.3, 0.9, 1.1, -3.5, 10, -3, 4, -4, 5, -3, 3, -3, 3, -2, 2, -2, 3, -4, 3, -3, 3, -7, 10],#CHI
        1610612739:[0.87, 1.11, -4, 4.2, 0.87, 1.1, -5, 5, 0.9, 1.1, -3.5, 10, -3, 4, -4, 5, -3, 3, -3, 3, -2, 2, -2, 3, -4, 3, -3, 3, -7, 10],#CLE
        1610612742:[0.91, 1.16, -4, 5.4, 0.9, 1.13, -5, 6, 0.93, 1.1, -3.5, 10, -3, 5, -4, 5, -3, 5, -3, 6, -2, 3, -2, 3, -4, 3, -3, 3, -7, 12],#DAL
        1610612743:[0.9, 1.13, -4, 5.3, 0.88, 1.13, -5, 6, 0.91, 1.1, -3.5, 10, -3, 4, -4, 4, -3, 4, -3, 4, -2, 3, -2, 3, -4, 3, -3, 3, -7, 12],#DEN
        1610612765:[0.88, 1.11, -4, 4.3, 0.87, 1.1, -5, 5, 0.88, 1.1, -3.5, 10, -3, 4, -4, 5, -3, 3, -3, 3, -2, 2, -2, 3, -4, 3, -3, 3, -7, 10],#DET
        1610612744:[0.89, 1.12, -4, 5, 0.87, 1.12, -5, 5.8, 0.93, 1.1, -3.5, 10, -3, 3, -3, 3, -3, 3, -3, 5, -2, 2, -2, 3, -4, 3, -3, 3, -7, 8],#GSW
        1610612745:[0.87, 1.17, -4, 5, 0.89, 1.17, -5, 7.3, 0.93, 1.1, -3.5, 10, -3, 4, -3, 4, -3, 4, -3, 5, -2, 4, -2, 2, -2, 4, -3, 3, -7, 12],#HOU
        1610612754:[0.9, 1.15, -4, 5.3, 0.88, 1.12, -5, 6.2, 0.9, 1.1, -3.5, 10, -3, 3, -3, 3, -3, 3, -3, 5, -2, 2, -2, 3, -4, 3, -3, 3, -7, 8],#IND
        1610612746:[0.91, 1.16, -4, 5, 0.88, 1.12, -5, 6, 0.9, 1.1, -3.5, 10, -3, 3, -3, 3, -3, 3, -3, 5, -2, 2, -2, 3, -4, 3, -3, 3, -7, 8],#LAC
        1610612763:[0.9, 1.15, -4, 5, 0.87, 1.1, -5, 5.4, 0.88, 1.1, -3.5, 10, -3, 4, -4, 5, -3, 3, -3, 3, -2, 2, -2, 3, -4, 3, -3, 3, -7, 10],#MEM
        1610612748:[0.91, 1.16, -4, 5.3, 0.88, 1.15, -5, 5.8, 0.94, 1.12, -3.5, 10, -3, 4, -4, 5, -3, 4, -3, 4, -2, 2, -2, 3, -4, 3, -3, 3, -7, 10],#MIA
        1610612750:[0.88, 1.13, -4, 4.3, 0.87, 1.1, -5, 5, 0.88, 1.1, -3.5, 10, -3, 4, -4, 5, -3, 4, -2, 4, -2, 2, -2, 3, -4, 3, -3, 3, -7, 10],#MIN
        1610612740:[0.88, 1.13, -4, 4.5, 0.87, 1.12, -5, 5, 0.91, 1.1, -3.5, 10, -3, 4, -4, 3, -3, 3, -2, 5, -2, 2, -2, 3, -4, 3, -3, 3, -7, 10],#NOR
        1610612752:[0.88, 1.11, -4, 4.1, 0.87, 1.1, -5, 5, 0.87, 1.1, -3.5, 10, -3, 4, -4, 3, -3, 3, -2, 5, -2, 2, -2, 3, -4, 3, -3, 3, -7, 10],#NYK
        1610612760:[0.89, 1.16, -4, 6, 0.88, 1.13, -5, 5, 0.9, 1.1, -3.5, 10, -3, 4, -4, 3, -3, 3, -2, 5, -2, 2, -2, 3, -4, 3, -3, 3, -7, 10],#OKC
        1610612753:[0.88, 1.12, -4, 4.2, 0.87, 1.1, -5, 5, 0.88, 1.1, -3.5, 10, -3, 4, -4, 3, -3, 3, -2, 5, -2, 2, -2, 3, -4, 3, -3, 3, -7, 10],#ORL
        1610612755:[0.93, 1.2, -4, 5, 0.87, 1.1, -5, 5, 0.9, 1.1, -3.5, 10, -3, 4, -4, 3, -3, 3, -2, 5, -2, 2, -2, 3, -4, 3, -3, 3, -7, 10],#PHI
        1610612756:[0.88, 1.12, -4, 4.4, 0.87, 1.11, -5, 6.2, 0.88, 1.1, -3.5, 10, -3, 4, -4, 3, -3, 3, -2, 5, -2, 2, -2, 3, -4, 3, -3, 3, -7, 10],#PHX
        1610612757:[0.89, 1.12, -4, 4.6, 0.87, 1.13, -5, 6.2, 0.88, 1.1, -3.5, 10, -3, 4, -4, 3, -3, 3, -2, 5, -2, 2, -2, 3, -4, 3, -3, 3, -7, 10],#POR
        1610612758:[0.88, 1.11, -4, 5, 0.87, 1.1, -5, 5, 0.88, 1.1, -3.5, 10, -4, 5, -4, 5, -3, 3, -3, 3, -2, 2, -2, 3, -4, 3, -3, 3, -7, 10],#SAC
        1610612759:[0.9, 1.12, -4, 4.5, 0.87, 1.11, -4, 4, 0.88, 1.1, -3.5, 10, -4, 5, -4, 5, -3, 3, -3, 5, -2 ,2, -2, 3, -4, 3, -3, 3, -7, 10],#SAS
        1610612761:[0.91, 1.17, -4, 5.2, 0.87, 1.12, -5, 6, 0.88, 1.1, -3.5, 10, -4, 5, -4, 5, -3, 3, -3, 5, -2, 2, -2, 3, -4, 3, -3, 3, -7, 10],#TOR
        1610612762:[0.9, 1.14, -4, 5.2, 0.87, 1.13, -5, 5.5, 0.88, 1.1, -3.5, 10, -3, 5, -4, 5, -3, 3, -3, 5, -2, 2, -2, 3, -4, 3, -3, 3, -7, 10],#UTA
        1610612764:[0.88, 1.11, -4, 4.6, 0.87, 1.11, -5, 6, 0.88, 1.1, -3.5, 10, -3, 4, -4, 5, -3, 3, -3, 5, -2, 2, -2, 3, -4, 3, -3, 3, -7, 10]#WIZ
    }
    return team_list_dist[team_id]

def get_bias_away(team_id):
    team_list_dist = {
        1610612749:[0.9, 1.15, -4, 5, 0.88, 1.11, -5, 5.5, 0.89, 1.1, -3, 9, -3, 5, -3, 4, -3, 4, -3, 3, -2, 2, -2, 3, -2, 1, -3, -3, -10, 10],#MIL
        1610612747:[0.9, 1.15, -4, 5, 0.88, 1.11, -5, 5.4, 0.86, 1.1, -3, 9, -4, 5, -2, 4, -3, 4, -4, 5, -3, 4, -2, 3, -1, 1, -3, 3, -7, 7], #LAL
        1610612737:[0.86, 1.1, -4, 4.4, 0.87, 1.1, -5.3, 6.5, 0.89, 1.1, -3, 9, -7,3, -2, 2, -4, 3, -3, 2, -2, 1, -1, 1, -3, 2, -3, 3, -4, 10],#ATL
        1610612738:[0.88, 1.12, -4, 5, 0.86, 1.1, -5.2, 5.5, 0.89, 1.1, -3, 9, -4, 4, -2, 2, -3, 3, -3, 5, -1, 3, -2, 3, -3, 2, -3, 3, -7, 10],#BOS
        1610612751:[0.86, 1.1, -4, 4.3, 0.85, 1.1, -5, 5, 0.89, 1.1, -3, 9, -3, 5, -4, 5, -3, 3, -3, 3, -2, 2, -2, 3, -4, 3, -3, 3, -7, 10],#BKN
        1610612766:[0.86, 1.1, -4, 4.2, 0.85, 1.1, -5, 5.3, 0.89, 1.1, -3, 9, -5, 3, -2, 2, -6, 3, -3, 2, -2, 1, -1, 1, -3, 2, -3, 3, -4, 10],#CHA
        1610612741:[0.89, 1.1, -4, 4.4, 0.86, 1.1, -5, 5.3, 0.89, 1.1, -3, 9, -3, 5, -4, 5, -3, 3, -3, 3, -2, 2, -2, 3, -4, 3, -3, 3, -7, 10],#CHI
        1610612739:[0.86, 1.1, -4, 4.2, 0.86, 1.1, -5, 5, 0.89, 1.1, -3, 9, -3, 5, -4, 5, -3, 3, -3, 3, -2, 2, -2, 3, -4, 3, -3, 3, -7, 10],#CLE
        1610612742:[0.89, 1.12, -4, 5.4, 0.87, 1.11, -5, 6, 0.92, 1.1, -3, 9, -3, 5, -4, 5, -3, 5, -3, 6, -2, 3, -2, 3, -4, 3, -3, 3, -7, 12],#DAL
        1610612743:[0.89, 1.1, -4, 5.3, 0.87, 1.11,-5, 6, 0.9, 1.1, -3, 9, -3, 4, -4, 4, -3, 4, -3, 4, -2, 3, -2, 3, -4, 3, -3, 3, -7, 12],#DEN
        1610612765:[0.86, 1.1, -4, 4.3, 0.87, 1.1, -5, 5, 0.87, 1.1, -3, 9, -3, 5, -4, 5, -3, 3, -3, 3, -2, 2, -2, 3, -4, 3, -3, 3, -7, 10],#DET
        1610612744:[0.87, 1.1, -4, 4, 0.86, 1.1, -5, 5.8, 0.92, 1.1, -3, 9, -3, 3, -3, 3, -3, 3, -3, 5, -2, 2, -2, 3, -4, 3, -3, 3, -7, 8],#GSW
        1610612745:[0.86, 1.12, -4, 5, 0.9, 1.12, -5, 7.3, 0.92, 1.1, -3, 9, -3, 4, -3, 4, -3, 4, -3, 5, -2, 4, -2, 2, -2, 4, -3, 3, -7, 12],#HOU
        1610612754:[0.89, 1.12, -4, 5.3, 0.87, 1.11, -5, 6.2, 0.89, 1.1, -3, 9, -3, 3, -3, 3, -3, 3, -3, 5, -2, 2, -2, 3, -4, 3, -3, 3, -7, 8],#IND
        1610612746:[0.9, 1.12, -4, 5, 0.87, 1.13, -5, 6, 0.89, 1.1, -3, 9, -3, 3, -3, 3, -3, 3, -3, 5, -2, 2, -2, 3, -4, 3, -3, 3, -7, 8],#LAC
        1610612763:[0.87, 1.11, -4, 5, 0.86, 1.11, -5, 5.4, 0.87, 1.1, -3, 9, -3, 4, -4, 5, -3, 3, -3, 3, -2, 2, -2, 3, -4, 3, -3, 3, -7, 10],#MEM
        1610612748:[0.9, 1.13, -4, 5.3, 0.91, 1.12, -5, 5.8, 0.93, 1.1, -3, 9, -3, 4, -4, 5, -3, 4, -3, 4, -2, 2, -2, 3, -4, 3, -3, 3, -7, 10],#MIA
        1610612750:[0.87, 1.1, -4, 4.3, 0.86, 1.1, -5, 5, 0.87, 1.1, -3, 9, -3, 4, -4, 5, -3, 4, -2, 4, -2, 2, -2, 3, -4, 3, -3, 3, -7, 10],#MIN
        1610612740:[0.87, 1.1, -4, 4.5, 0.86, 1.12, -5, 5, 0.9, 1.1, -3, 9, -3, 4, -4, 3, -3, 3, -2, 5, -2, 2, -2, 3, -4, 3, -3, 3, -7, 10],#NOR
        1610612752:[0.86, 1.1, -4, 4.1, 0.86, 1.9, -5, 5, 0.86, 1.1, -3, 9, -3, 4, -4, 3, -3, 3, -2, 5, -2, 2, -2, 3, -4, 3, -3, 3, -7, 10],#NYK
        1610612760:[0.88, 1.14, -4, 5, 0.88, 1.13, -5, 5, 0.89, 1.1, -3, 9, -3, 4, -4, 3, -3, 3, -2, 5, -2, 2, -2, 3, -4, 3, -3, 3, -7, 10],#OKC
        1610612753:[0.87, 1.1, -4, 4.2, 0.85, 1.1, -5, 5, 0.87, 1.1, -3, 9, -3, 4, -4, 3, -3, 3, -2, 5, -2, 2, -2, 3, -4, 3, -3, 3, -7, 10],#ORL
        1610612755:[0.88, 1.12, -4, 5, 0.85, 1.1, -4, 4, 0.89, 1.1, -3, 9, -3, 4, -4, 3, -3, 3, -2, 5, -2, 2, -2, 3, -4, 3, -3, 3, -7, 10],#PHI
        1610612756:[0.87, 1.11, -4, 4.4, 0.86, 1.1, -5, 5.4, 0.87, 1.1, -3, 9, -3, 4, -4, 3, -3, 3, -2, 5, -2, 2, -2, 3, -4, 3, -3, 3, -7, 10],#PHX
        1610612757:[0.88, 1.11, -4, 4.6, 0.87, 1.11, -5, 6.2, 0.87, 1.1, -3, 9, -3, 4, -4, 3, -3, 3, -2, 5, -2, 2, -2, 3, -4, 3, -3, 3, -7, 10],#POR
        1610612758:[0.87, 1.1, -4, 5, 0.85, 1.1, -5, 5, 0.87, 1.1, -5, 5, -3, 9, -4, 5, -3, 3, -3, 3, -2, 2, -2, 3, -4, 3, -3, 3, -7, 10],#SAC
        1610612759:[0.88, 1.1, -4, 4.4, 0.85, 1.11, -4, 4, 0.87, 1.1, -5, 5, -3, 9, -4, 5, -3, 3, -3, 5, -2 ,2, -2, 3, -4, 3, -3, 3, -7, 10],#SAS
        1610612761:[0.9, 1.14, -4, 5.3, 0.88, 1.12, -5, 6, 0.9, 1.1, -5, 5, -3, 9, -4, 5, -3, 3, -3, 5, -2, 2, -2, 3, -4, 3, -3, 3, -7, 10],#TOR
        1610612762:[0.89, 1.14, -4, 5.3, 0.88, 1.12, -5, 5.5, 0.9, 1.1, -5, 5, -3, 9, -4, 5, -3, 3, -3, 5, -2, 2, -2, 3, -4, 3, -3, 3, -7, 10],#UTA
...
def playoff_sim(home_id,away_id):
    ...
    if total_points_away == total_points_home:
        total_points_home+= 1
        home_game_stats['free_throws_made'] += 1
        if home_game_stats['free_throws_made'] > home_game_stats['free_throws_attempted']:
             home_game_stats['free_throws_attempted']+=1
             
    return {
        home_id: total_points_home,
        away_id: total_points_away
    }
