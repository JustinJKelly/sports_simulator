...
urlpatterns = [
    ...
    path('team/standings_mobile', views.standings_page_mobile, name="standings_page_mobile"),
    ...
    path('playoffs_mobile/series/<int:id>', views.series_page_mobile, name="series_page_mobile"),
